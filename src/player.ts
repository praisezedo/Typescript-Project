...
let index : number = tasks.length - 1;
...
let Items = document.querySelector('ol')! as HTMLOListElement;
...
const  Items = document.getElementById('list-of-items')! as HTMLOListElement;
Items.innerHTML = `
${tasks.map((t , i) => {
