...
class Expense {
    constructor(type, desc, amount, date, id) {
        this.type = type;
        this.desc = desc;
        this.amount = amount;
        this.date = date;
        if (typeof id === 'number') {
            ...
            if (id > Expense.currentId)
                Expense.currentId = id;
        }
        else {
...
function addExpense() {
    ...
    const expense = new Expense(selectedType, description.toUpperCase(), amount, date);
